...
public class TrustedHostsProvider implements TrustedHostsProviderExtension {
  ...
  public TrustedHostsProvider() {
    ...
    optionsStorage.addOptionListener(new WSOptionListener(RestConfigExtension.REST_SERVER_URL) {
      @Override
  ...
  private void updateEnforcedHost(WSOptionsStorage optionsStorage) {
    ...
    String enforcedUrl = optionsStorage.getOption(RestConfigExtension.REST_SERVER_URL, "");
